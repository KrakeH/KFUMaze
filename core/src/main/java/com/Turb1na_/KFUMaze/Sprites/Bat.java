...
public class Bat {
    ...
    public Bat(final Main game, Vector2 position, Vector2 size, String map[], Vector2 speed, boolean isY) {
        this.game = game;
        this.map = map;
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(game.tm.batTexture, position.x * Main.SIZECHANGE.x, position.y * Main.SIZECHANGE.y, size.x * Main.SIZECHANGE.x, size.y * Main.SIZECHANGE.y);
    }
